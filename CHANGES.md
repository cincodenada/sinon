...
This demonstrates the status quo of the release script, including a line that is way too long in the changes.md after hand-editing to demonstrate how the prettier run for CHANGES.md is handled

## 12.0.2-releases-status-quo
...
_Released by Joel Bradshaw on 2022-01-23._
